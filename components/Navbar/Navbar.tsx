...
const Navbar = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#fff] shadow-md rounded-[100px]">
        <input type="text" 
               placeholder="Search" 
        ...
        <div className="w-[72px] h-full rounded-[20px] bg-[#4e53c9] flex justify-center items-center cursor-pointer">
      ...
      {/* Small screen navigation */}
        ...
        <div className="w-[40px] h-[40px] rounded-[10px] bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <img src={logo.src} alt="user" className="w-[60%] h-[60%] object-contain" />
          </div>
